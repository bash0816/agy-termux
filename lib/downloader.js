...
async function fetchLatestMeta() {
  ...
  // AGY_TERMUX_FORCE_LATEST 経路は検証済みバージョンではないため sha256Binary は付与しない
  // (downloadBinary 側で照合をスキップさせる)
  return { tagName: meta.tag_name, downloadUrl: asset.browser_download_url, sha256Binary: null };
}
...
async function downloadBinary(downloadUrl, expectedSha256Binary) {
